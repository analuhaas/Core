...
if isempty(scriptDir)
    scriptDir = fileparts(which('calibration_supervisor_LOW1'));
end
if isempty(scriptDir)
    scriptDir = pwd;
end
...
boardName = "board_M6_LOW1";   % one calibration file per board

N_BOARD_READS      = 10;   % board reads averaged per point
BOARD_READ_PAUSE_S = 0.1; % pause between two board reads
...
% duty cycle 1 -> V_HIGH = V1_LOW).
BOARD_MODE = 1;     % 0 = idle, 1 = LEG1 at duty 1.0 (LOW1), 2 = LEG2 at duty 1.0 (LOW2)
...
sensorMap = { ...
    ...
    'V1_LOW', 'rV1Low_raw', '10133/0147', 3,   0.1, 50, 'V'; ...
    'I1_LOW', 'rI1Low_raw', '10133/0147', 4,   0.1,  2, 'A'; ...
    };
