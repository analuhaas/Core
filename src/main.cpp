...
void loop_background_task()
{
    if (module_ID == MMC_LEAD)
    {
        ...
        {
            spin.led.toggle();
            printk("%.3f:", (double)number_of_connected_submodules_upper_arm);
            printk("%.3f:", (double)modules_capacitor_voltages_upper_arm[0]);
            printk("%.3f:", (double)modules_capacitor_voltages_upper_arm[1]);
            printk("%.3f:", (double)modules_capacitor_voltages_upper_arm[2]);
            printk("%.3f:", (double)modules_capacitor_voltages_upper_arm[3]);
            printk("%.3f:", (double)modules_capacitor_voltages_upper_arm[4]);
            printk("\n");
        }
    }
